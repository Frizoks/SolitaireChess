...
:genererCompileList
    SETLOCAL ENABLEDELAYEDEXPANSION
        ...
        IF EXIST "%~1" (
            ...
            echo dossier = inputbox ^("Veuillez entrez le dossier racine à partir du quel la compile.list vas etre generer"^, "Selectionner un dossier"^) > %nomFichierChoixDossier%
...
::-----------------------------------------------------------::
:: Liste les fichiers pour le dossiers en cours nommer source ::
::-----------------------------------------------------------::
:ListerFichiers
